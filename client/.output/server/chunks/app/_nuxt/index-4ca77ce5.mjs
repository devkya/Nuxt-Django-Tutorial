import { toRef, toRefs, computed, Text, ref, watchEffect, capitalize, h, readonly, isRef, unref, createVNode, provide, inject, watch, reactive, mergeProps, resolveDynamicComponent, nextTick, withDirectives, resolveDirective, withCtx, createTextVNode, useSSRContext, Fragment } from 'vue';
import { ssrRenderComponent } from 'vue/server-renderer';
import { p as propsFactory, m as makeThemeProps, e as genericComponent, f as provideTheme, h as provideDefaults, I as IconValue, q as useIcon, o as convertToUnit, x as breakpoints, _ as _export_sfc, g as getCurrentInstance, a as getCurrentInstanceName, j as getUid, u as useProxiedModel, k as deepEqual, d as destructComputed, i as includes, t as useRtl, v as hasEvent, b as isCssColor, w as wrapInArray, l as findChildrenWithProvide, n as consoleWarn, r as isObject, s as keyCodes } from '../server.mjs';
import 'ofetch';
import 'hookable';
import 'unctx';
import '@unhead/ssr';
            ...
            if (_push3) {
              _push3(ssrRenderComponent(VCol, { cols: "12" }, {
                default: withCtx((_3, _push4, _parent4, _scopeId3) => {
                  if (_push4) {
                    _push4(`<h1${_scopeId3}>Home View</h1>`);
                  } else {
                    return [
                      createVNode("h1", null, "Home View")
                    ];
                  }
                }),
                _: 1
...
//# sourceMappingURL=index-4ca77ce5.mjs.map
